...
namespace service::timer {
    ...
    const std::shared_ptr<std::vector<int>> EntralinkTimer::createStages(
        const int targetDelay, const int targetSecond, const int calibration,
    ...
    int EntralinkTimer::createStage1(const int targetDelay,
                                     const int targetSecond,
                                     const int calibration) const {
        return delayTimer->createStage1(targetDelay, targetSecond,
                                        calibration) +
               250;
    }
    ...
    int EntralinkTimer::createStage2(const int targetDelay,
                                     ...
                                     const int entralinkCalibration) const {
        return delayTimer->createStage2(targetDelay, calibration) -
               entralinkCalibration;
    }

    int EntralinkTimer::calibrate(const int targetDelay,
                                  const int delayHit) const {
