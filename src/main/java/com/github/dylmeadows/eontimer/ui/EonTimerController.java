...
public class EonTimerController extends BindableController<EonTimerModel, EonTimerView> implements
        ModelChangeListener<EonTimerModel>,
        ViewChangeListener<EonTimerView> {
