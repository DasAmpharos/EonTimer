...
namespace model::settings {
    ...
    TimerSettingsModel::TimerSettingsModel(QSettings *settings) {
        ...
        console = model::console(settings->value(TimerSettingsFields::CONSOLE,
                                                 TimerSettingsFields::Defaults::CONSOLE).toInt());
        refreshInterval = std::chrono::milliseconds(settings->value(TimerSettingsFields::REFRESH_INTERVAL,
                                                                    TimerSettingsFields::Defaults::REFRESH_INTERVAL).toULongLong());
        precisionCalibrationEnabled = settings->value(TimerSettingsFields::PRECISION_CALIBRATION_ENABLED,
                                                      TimerSettingsFields::Defaults::PRECISION_CALIBRATION_ENABLED).toBool();
        settings->endGroup();
    }
    ...
    model::Console TimerSettingsModel::getConsole() const {
        return console;
    }
